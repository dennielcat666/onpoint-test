	...
	return (
		<li className={styles.wrapper}>
			<div className={styles.contentBlock}>
				<div className={styles.textBlock}>
					...
					<div className={styles.subText}>
						brend<span className={styles.subTextSpan}>xy</span>
					</div>
				</div>
				<div className={styles.infoBlock}>
					<div className={cn(styles.infoCol, styles.infoColLeft)}>
						Ehicula ipsum a arcu cursus vitae. Eu non diam phasellus vestibulum lorem
						sed risus ultricies
					...
					<div>
						...
						<Button className={styles.buttonScreen} onClick={handleClick}>
							Подробнее
						</Button>
					</div>
				</div>
			...
			<Popup isShow={showPopup} onClose={setShowPopup}>
				...
				<div className={styles.subTextPopup}>
					brend<span className={styles.subTextSpanPopup}>xy</span>
				</div>
				<Slider>
					<Slide>
